...
import br.com.componentes.dotloader.AnimationRepeater;
import br.com.componentes.dotloader.CubicBezierInterpolator;
import br.com.componentes.dotloader.Dot;
    ...
    public void setNumberOfDots(int numberOfDots) {
        ...
        if (numberOfDots < mDots.length) {
            ...
            for (int i = mDots.length; i < numberOfDots; i++) {
                ...
                newDots[i].positionAnimator = clonePositionAnimatorForDot(newDots[0].positionAnimator, newDots[i]);
                newDots[i].colorAnimator = cloneColorAnimatorForDot(newDots[0].colorAnimator, newDots[i]);
