...
import br.com.componentes.zoom.RandomTransitionGenerator;
import br.com.componentes.zoom.Transition;
import br.com.componentes.zoom.TransitionGenerator;
...
public class ZoomFrameImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public ZoomFrameImageView(Context context) {
        this(context, null);
    }


    public ZoomFrameImageView(Context context, AttributeSet attrs) {
